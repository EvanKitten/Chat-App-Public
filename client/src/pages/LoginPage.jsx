  ...
  return (
    ...
    sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      rounded-lg shadow-lg'>
        ...
        {/*When signup is the current state and other data is not submitted, display this input tag */}
        ...
        {/*When data is not submitted, ask for user email and pass */}
        {!isDataSubmitted && (
            <>
        ...
        <div className='flex flex-col gap-2'>
            {currState === "Sign up" ? (
                ...
                {setCurrState("Login"); setIsDataSubmitted(false)}} className='font-medium 
